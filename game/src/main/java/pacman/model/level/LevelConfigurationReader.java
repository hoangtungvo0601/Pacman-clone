...
public class LevelConfigurationReader {
    ...
    public Map<GhostMode, Integer> getGhostModeLengths() {
        ...
        ghostModeLengths.put(GhostMode.CHASE, ((Number) modeLengthsObject.get("chase")).intValue() * 30);
        ghostModeLengths.put(GhostMode.SCATTER, ((Number) modeLengthsObject.get("scatter")).intValue() * 30);
        ghostModeLengths.put(GhostMode.FRIGHTENED, ((Number) modeLengthsObject.get("frightened")).intValue() * 30);
        ghostModeLengths.put(GhostMode.READY, 30);
    ...
    public Map<GhostMode, Double> getGhostSpeeds() {
        ...
        ghostSpeeds.put(GhostMode.READY, 0.0);
        return ghostSpeeds;
    }
}
